...
export const CreateRoomForm = () => {
  ...
  const handleAutoDisposeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setValues({ ...values, autoDispose: !event.target.checked })
  }
  ...
  return (
    <CreateRoomFormWrapper onSubmit={handleSubmit}>
      ...
      <FormControlLabel
        control={
          <Checkbox
            checked={!values.autoDispose}
            onChange={handleAutoDisposeChange}
            color="secondary"
          />
        }
        label="Keep this room always open"
      />
