...
export default class Game extends Phaser.Scene {
  ...
  create(data: { network: Network }) {
    ...
    const handleWheelZoom = (event: WheelEvent) => {
      console.log('wheel event fired, deltaY:', event.deltaY, 'deltaMode:', event.deltaMode)
      const newZoom = this.cameras.main.zoom - event.deltaY * 0.001
      this.cameras.main.zoom = Phaser.Math.Clamp(newZoom, 0.5, 3)
      console.log('new zoom:', this.cameras.main.zoom)
    }
